...
This installation guide provides comprehensive instructions for setting up Agentic-code on various platforms. For more specific information, refer to the [User Guide](/docs/user/user-guide.md) or [API Documentation](/docs/developer/api-reference.md).